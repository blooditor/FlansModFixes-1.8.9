...
// Gun
    ...
    gunModel[6] = new ModelRendererTurbo(this, 0, 230, textureX,
        textureY); // GN.MainWoodenBodyBottomBack
    gunModel[7] = new ModelRendererTurbo(this, 0, 230, textureX,
        textureY); // GN.MainWoodenBodyBottomfront
    ...
    gunModel[13] = new ModelRendererTurbo(this, 0, 100, textureX,
        textureY); // GN.Forwardmetalbinder
