...
public class RewardBoxInstance {
  ...
  public static RewardBoxInstance CreatePurchasedReward(RewardBox box, EntityPlayer player,
      EntityPlayer commandSender) {
    FlansMod.log(
        "--------------------------------------------------------------------------------------------------------------------------------------------");
    FlansMod.log("PURCHASED REWARD BOX MANUALLY REDEEMED FOR USER: " + player.getDisplayNameString()
        + " BY PLAYER " + commandSender.getDisplayNameString());
    FlansMod.log(
        "--------------------------------------------------------------------------------------------------------------------------------------------");
  ...
  public static RewardBoxInstance CreateRewardBoxInstanceFromNBT(int boxHash, int unlockHash,
      int type) {
