...
// Nose
    ...
    noseModel[1] = new ModelRendererTurbo(this, 0, 0, textureX,
        textureY); // NS.Core/NoseTransitionTop
    noseModel[2] = new ModelRendererTurbo(this, 280, 440, textureX,
        textureY); // NS.Core/NoseTransitionBottom
    noseModel[3] = new ModelRendererTurbo(this, 280, 400, textureX, textureY); // NS.NoseAirIntake
    noseModel[4] = new ModelRendererTurbo(this, 280, 350, textureX,
        textureY); // NS.EngineThingiesLeft
    noseModel[5] = new ModelRendererTurbo(this, 280, 350, textureX,
        textureY); // NS.EngineThingiesRight
    ...
    propellerModels[0][0] = new ModelRendererTurbo(this, 0, 450, textureX,
        textureY); //Propeller 0 - Blade 0 : 192, 12 is the texture origin
    propellerModels[0][1] = new ModelRendererTurbo(this, 0, 450, textureX,
        textureY); //Propeller 0 - Blade 1
    propellerModels[0][2] = new ModelRendererTurbo(this, 0, 450, textureX,
        textureY); //Propeller 0 - Blade 2
...
// Body
    ...
    bodyModel[3] = new ModelRendererTurbo(this, 440, 490, textureX,
        textureY); // CR.FrontLeftSideTube
    bodyModel[4] = new ModelRendererTurbo(this, 440, 490, textureX,
        textureY); // CR.FrontRightSideTube
    ...
    bodyModel[8] = new ModelRendererTurbo(this, 440, 490, textureX,
        textureY); // CR.BackRightSideTube
    bodyModel[9] = new ModelRendererTurbo(this, 440, 490, textureX,
        textureY); // CR.BackLeftSideTube
    bodyModel[10] = new ModelRendererTurbo(this, 420, 480, textureX,
        textureY); // CR.RightTopSideTube
...
// Bay
    ...
    bayModel[2] = new ModelRendererTurbo(this, 300, 210, textureX,
        textureY); // BY.Core/Bayconnector
...
// Tail
    ...
    tailModel[0] = new ModelRendererTurbo(this, 180, 235, textureX,
        textureY); // TL.Dorsal/FlapCapital
...
// Left Wing
    ...
    leftWingModel[1] = new ModelRendererTurbo(this, 390, 0, textureX,
        textureY); // LW.LeftWingBackCenter
    leftWingModel[2] = new ModelRendererTurbo(this, 390, 20, textureX,
        textureY); // LW.LeftWingFlapSupport
    leftWingModel[3] = new ModelRendererTurbo(this, 390, 80, textureX,
        textureY); // LW.LeftWingOuterTip
    leftWingModel[4] = new ModelRendererTurbo(this, 20, 80, textureX,
        textureY); // LW.LeftWingForwards
...
// Right Wing
    ...
    rightWingModel[0] = new ModelRendererTurbo(this, 200, 0, textureX,
        textureY); // RW.RightWingMain
    rightWingModel[1] = new ModelRendererTurbo(this, 390, 0, textureX,
        textureY); // RW.RightWingBackCenter
    rightWingModel[2] = new ModelRendererTurbo(this, 390, 20, textureX,
        textureY); // RW.RightWingFlapSupport
    rightWingModel[3] = new ModelRendererTurbo(this, 390, 80, textureX,
        textureY); // RW.RightWingOuterTip
    rightWingModel[4] = new ModelRendererTurbo(this, 20, 80, textureX,
        textureY); // RW.RightWingForwards
...
// Yaw Flap
    ...
    yawFlapModel[3] = new ModelRendererTurbo(this, 200, 460, textureX,
        textureY); // YF.TailYawFlapTop
...
// Pitch Flap Left
    ...
    pitchFlapLeftModel[0] = new ModelRendererTurbo(this, 400, 460, textureX,
        textureY); // LF.LeftPedal
    pitchFlapLeftModel[1] = new ModelRendererTurbo(this, 0, 220, textureX,
        textureY); // LF.LeftWingFlap
    pitchFlapLeftModel[2] = new ModelRendererTurbo(this, 200, 430, textureX,
        textureY); // LF.LeftTailFlap
...
// Pitch Flap Right
    ...
    pitchFlapRightModel[0] = new ModelRendererTurbo(this, 400, 460, textureX,
        textureY); // RF.RightPedal
    pitchFlapRightModel[1] = new ModelRendererTurbo(this, 0, 220, textureX,
        textureY); // RF.RightWingFlap
    pitchFlapRightModel[2] = new ModelRendererTurbo(this, 200, 430, textureX,
        textureY); // RF.RightTailFlap
