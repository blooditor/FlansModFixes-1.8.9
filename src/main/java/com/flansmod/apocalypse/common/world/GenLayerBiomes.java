...
public class GenLayerBiomes extends GenLayer {
  ...
  protected BiomeGenBase[] commonBiomes = {BiomeGenApocalypse.deepCanyon,
      /*BiomeGenApocalypse.canyon,*/ BiomeGenApocalypse.desert, /*BiomeGenApocalypse.plateau,*/
      BiomeGenApocalypse.highPlateau};
