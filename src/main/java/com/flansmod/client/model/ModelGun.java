...
public class ModelGun extends ModelBase {
  ...
  /**
   * The point about which the minigun barrel rotates. Rotation is along the line of the gun through
   * this point
   */
  ...
  /**
   * If true, then the scope attachment will move with the break action. Can be combined with the
   * above
   */
  public boolean scopeIsOnBreakAction = false;
  /**
   * For rifles and shotguns. Currently a generic reload animation regardless of how full the
   * internal magazine already is
   */
  ...
  /**
   * Custom reload Parameters. If Enum.CUSTOM is set, these parameters can build an animation within
   * the gun model classes
   */
