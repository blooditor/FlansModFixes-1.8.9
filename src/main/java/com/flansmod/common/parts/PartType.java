...
public class PartType extends InfoType {
  ...
  public int fuel = 0;
  /**
   * The types of driveables that this engine works with. Used to designate some engines as mecha
   * CPUs and whatnot
   */
  ...
  /**
   * If set to false, then this engine will definitely not be the default for creatively spawned
   * vehicles
   */
  ...
  //------- RedstoneFlux -------
  /**
   * If true, then this engine will draw from RedstoneFlux power source items such as power cubes.
   * Otherwise it will draw from Flan's Mod fuel items
   */
  ...
  /**
   * The default engine (normally the first one read by the type loader) for driveables with corrupt
   * nbt or those spawned in creative
   */
