...
public class WorldChunkManagerApocalypse extends WorldChunkManager {
  ...
  public BiomeGenBase getBiomeGenerator(BlockPos pos) {
    BiomeGenBase biome = this.myBiomeCache
        .func_180284_a(pos.getX(), pos.getZ(), null);
    if (biome == null) {
  ...
  @Override
  public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int x, int z,
  ...
  @Override
  public BiomeGenBase[] loadBlockGeneratorData(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2,
      int par3, int par4, int par5) {
    return getBiomeGenAt(par1ArrayOfBiomeGenBase, par2, par3, par4, par5, true);
  }

  @Override
  public BiomeGenBase[] getBiomeGenAt(BiomeGenBase[] par1ArrayOfBiomeGenBase, int x, int y,
  ...
  public BlockPos findBiomePosition(int x, int z, int range, List biomes, Random par5Random) {
    ...
    for (int l1 = 0; l1 < ai.length; l1++) {
      ...
      if ((biomes.contains(biomegenbase)) && ((blockpos == null) || (par5Random.nextInt(k1 + 1)
          == 0))) {
