...
public class BiomeDecoratorApocalypse extends BiomeDecorator {
  ...
  public void decorate(World worldIn, Random p_180292_2_, BiomeGenBase p_180292_3_,
    ...
    if (this.currentWorld != null) {
      ...
      if (s != null) {
        ...
        this.chunkProviderSettings = ChunkProviderSettings.Factory.jsonToFactory("")
            .func_177864_b();
      }
      ...
      this.goldGen = new WorldGenMinable(Blocks.gold_ore.getDefaultState(),
          this.chunkProviderSettings.goldSize);
  ...
  protected void genDecorations(BiomeGenBase biome) {
    MinecraftForge.EVENT_BUS
        .post(new DecorateBiomeEvent.Pre(currentWorld, randomGenerator, field_180294_c));
    ...
    if (this.generateSulphurLakes) {
      ...
      for (j = 0; doGen && j < 15; ++j) {
        blockpos1 = this.field_180294_c
            .add(this.randomGenerator.nextInt(16) + 8, this.randomGenerator.nextInt(10) + 30,
                this.randomGenerator.nextInt(16) + 8);
        (new WorldGenSulphurPool(FlansModApocalypse.blockSulphuricAcid))
            .generate(this.currentWorld, this.randomGenerator, blockpos1);
      }
    }

    //Ore generation
    MinecraftForge.ORE_GEN_BUS
        .post(new OreGenEvent.Pre(currentWorld, randomGenerator, field_180294_c));
    ...
    MinecraftForge.ORE_GEN_BUS
        .post(new OreGenEvent.Post(currentWorld, randomGenerator, field_180294_c));
         ...
         */
    MinecraftForge.EVENT_BUS
        .post(new DecorateBiomeEvent.Post(currentWorld, randomGenerator, field_180294_c));
  }
