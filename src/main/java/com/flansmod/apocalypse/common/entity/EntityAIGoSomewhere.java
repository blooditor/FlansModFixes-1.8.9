...
public class EntityAIGoSomewhere extends EntityAIBase {
  ...
  public boolean shouldExecute() {
    {
      Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockTowards(this.theEntityCreature, 5, 4,
          new Vec3(theEntityCreature.posX + directionX, theEntityCreature.posY,
              theEntityCreature.posZ + directionZ));
