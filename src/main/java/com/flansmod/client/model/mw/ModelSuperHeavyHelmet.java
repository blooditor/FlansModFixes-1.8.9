...
public class ModelSuperHeavyHelmet extends ModelCustomArmour {
  ...
  public ModelSuperHeavyHelmet() {
    ...
    headModel[3].addShapeBox(-5.5F, -7F, -4.5F, 1, 7, 9, 0F, /* 0 */ 1F, 0F, 0F, /* 1 */ -1F, 0F,
        0F, /* 2 */ -1F, 0F, 1F, /* 3 */ 1F, 0F, 2F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */
        0F, 0F, 0F, /* 7 */ 0F, 0F, 0F);

    headModel[4] = new ModelRendererTurbo(this, 40, 45, textureX, textureY);
    headModel[4]
        .addShapeBox(4.5F, -7F, -4.5F, 1, 7, 9, 0F, /* 0 */ -1F, 0F, 0F, /* 1 */ 1F, 0F, 0F, /* 2 */
            1F, 0F, 2F, /* 3 */ -1F, 0F, 1F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            1F, /* 7 */ 0F, 0F, 0F);

    headModel[5] = new ModelRendererTurbo(this, 64, 0, textureX, textureY);
    headModel[5].addShapeBox(-4.5F, -7F, 4.5F, 9, 7, 1, 0F, /* 0 */ 1F, 0F, -1F, /* 1 */ 1F, 0F,
        -1F, /* 2 */ 2F, 0F, 1F, /* 3 */ 2F, 0F, 1F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */
        1F, 0F, 0F, /* 7 */ 1F, 0F, 0F);

    //Faceplate
    headModel[6] = new ModelRendererTurbo(this, 64, 8, textureX, textureY);
    headModel[6]
        .addShapeBox(-4F, -7F, -5.5F, 8, 7, 1, 0F, /* 0 */ 0F, 0F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */
            1F, 0F, 0F, /* 3 */ 1F, 0F, 0F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 1F, 0F,
            0F, /* 7 */ 1F, 0F, 0F);
