...
/**
 * This represents a round in the teams mod It designates the map, gametype and teams to be played
 * that round A list of valid rounds is kept by the TeamsManager and then either players vote on
 * which rounds to play or there is a rotation
 */
public class TeamsRound implements Comparable<TeamsRound> {
  ...
  public TeamsRound(TeamsMap map2, Gametype gametype2, Team[] teams2, int timeLimit,
      int scoreLimit) {
    map = map2;
    gametype = gametype2;
    teams = teams2;
