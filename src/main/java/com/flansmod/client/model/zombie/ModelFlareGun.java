...
public class ModelFlareGun extends ModelGun {
  ...
  public ModelFlareGun() {
    ...
    gunModel[0]
        .addShapeBox(-1F, -2F, -0.5F, 2, 4, 1, 0F, /* 0 */ 0F, 0F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */
            0F, 0F, 0F, /* 3 */ 0F, 0F, 0F, /* 4 */ -1F, 0F, 0F, /* 5 */ 1F, 0F, 0F, /* 6 */ 1F, 0F,
            0F, /* 7 */ -1F, 0F, 0F);

    gunModel[1] = new ModelRendererTurbo(this, 6, 0, textureX, textureY);
    gunModel[1]
        .addShapeBox(1F, 0F, -0.5F, 5, 2, 1, 0F, /* 0 */ -0.5F, 0F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */
            0F, 0F, 0F, /* 3 */ -0.5F, 0F, 0F, /* 4 */ -1F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F,
            0F, 0F, /* 7 */ -1F, 0F, 0F);

    gunModel[2] = new ModelRendererTurbo(this, 18, 0, textureX, textureY);
    gunModel[2]
        .addShapeBox(0F, 2F, -0.5F, 2, 2, 1, 0F, /* 0 */ 0F, 0F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */ 0F,
