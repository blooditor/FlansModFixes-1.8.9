...
public class ItemGrenade extends ItemShootable implements IFlanItem {
  ...
  public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
    PlayerData data = PlayerHandler
        .getPlayerData(player, world.isRemote ? Side.CLIENT : Side.SERVER);
    ...
    if (type.canThrow && data != null && data.shootTimeRight <= 0 && data.shootTimeLeft <= 0) {
      ...
      if (type.dropItemOnThrow != null) {
        ...
        world.spawnEntityInWorld(
            new EntityItem(world, player.posX, player.posY, player.posZ, dropStack));
      }
    }
    return stack;
  }
  ...
  public EntityShootable Shoot(World world,
      Vector3f origin,
      Vector3f direction,
