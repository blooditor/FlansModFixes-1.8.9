...
public class PacketDriveableControl extends PacketBase {
  ...
  public void handleServerSide(EntityPlayerMP playerEntity) {
    if (playerEntity == null || playerEntity.worldObj == null
        || playerEntity.worldObj.loadedEntityList == null) {
      return;
    }
  ...
  protected void updateDriveable(EntityDriveable driveable, boolean clientSide) {
    driveable
        .setPositionRotationAndMotion(posX, posY, posZ, yaw, pitch, roll, motX, motY, motZ, avelx,
            avely, avelz, throttle, steeringYaw);
