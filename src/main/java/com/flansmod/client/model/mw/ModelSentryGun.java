...
public class ModelSentryGun extends ModelAAGun {
  ...
  public ModelSentryGun() {
    ...
    baseModel[1]
        .addShapeBox(-4F, 0F, -4F, 2, 16, 2, 0F, /* 0 */ 4F, 0F, 4F, /* 1 */ -4F, 0F, 4F, /* 2 */
            -4F, 0F, -4F, /* 3 */ 4F, 0F, -4F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F,
            0F, 0F, /* 7 */ 0F, 0F, 0F);

    baseModel[2] = new ModelRendererTurbo(this, 40, 0, textureX, textureY);
    baseModel[2]
        .addShapeBox(2F, 0F, -4F, 2, 16, 2, 0F, /* 0 */ -4F, 0F, 4F, /* 1 */ 4F, 0F, 4F, /* 2 */ 4F,
            0F, -4F, /* 3 */ -4F, 0F, -4F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            0F, /* 7 */ 0F, 0F, 0F);

    baseModel[3] = new ModelRendererTurbo(this, 48, 0, textureX, textureY);
    baseModel[3]
        .addShapeBox(2F, 0F, 2F, 2, 16, 2, 0F, /* 0 */ -4F, 0F, -4F, /* 1 */ 4F, 0F, -4F, /* 2 */4F,
            0F, 4F, /* 3 */ -4F, 0F, 4F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            0F, /* 7 */ 0F, 0F, 0F);

    baseModel[4] = new ModelRendererTurbo(this, 56, 0, textureX, textureY);
    baseModel[4]
        .addShapeBox(-4F, 0F, 2F, 2, 16, 2, 0F, /* 0 */ 4F, 0F, -4F, /* 1 */ -4F, 0F, -4F, /* 2 */
            -4F, 0F, 4F, /* 3 */ 4F, 0F, 4F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            0F, /* 7 */ 0F, 0F, 0F);
