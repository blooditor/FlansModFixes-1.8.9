...
public class WorldGenDyeFactory extends WorldGenFlan {
  ...
  public boolean generate(World world, Random rand, BlockPos pos) {
    ...
    //Set our base
    fillArea(world, x, minHeight, z, x + 16, maxHeight + 1, z + 16,
    ...
    //Horizontal logs
    fillArea(world, x, y + 4, z, x + 6, y + 5, z + 1,
        Blocks.log.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.X));
    fillArea(world, x, y + 4, z + 15, x + 6, y + 5, z + 16,
        Blocks.log.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.X));
    fillArea(world, x, y + 4, z, x + 1, y + 5, z + 16,
        Blocks.log.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Z));
    fillArea(world, x + 5, y + 4, z, x + 6, y + 5, z + 16,
        Blocks.log.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Z));
    //Vertical logs
    for (int i = 0; i < 6; i += 5) {
      for (int k = 0; k < 16; k += 5) {
        fillArea(world, x + i, y + 1, z + k, x + i + 1, y + 6, z + k + 1,
    ...
    world.setBlockState(new BlockPos(x + 1, y, z + 6),
    ...
    world.setBlockState(new BlockPos(x + 1, y, z + 9),
        FlansModApocalypse.getLootGenerator().getRandomWeaponBox(rand).getDefaultState());

    //Build chest racks
    for (int i = 1; i < 6; i += 3) {
      for (int k = 1; k < 6; k += 3) {
        fillArea(world, x + i, y, z + k, x + i + 1, y + 3, z + k + 1,
    ...
    //Build sewing table
    fillArea(world, x + 1, y, z + 11, x + 2, y + 1, z + 15,
  ...
  private void buildVat(World world, Random rand, int x, int y, int z) {
    ...
    fillArea(world, x + 1, y, z + 1, x + 3, y + (tall ? 2 : 1), z + 3,
        Blocks.wool.getStateFromMeta(rand.nextInt(16)));
  }
}
