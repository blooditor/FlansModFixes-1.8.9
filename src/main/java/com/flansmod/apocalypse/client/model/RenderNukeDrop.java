...
public class RenderNukeDrop extends Render {
  ...
  public void render(Entity entity, double x, double y, double z, float p_76986_8_,
      float partialTicks) {
  ...
  public void renderWorld(RenderWorldLastEvent event) {
    ...
    for (Object entity : world.loadedEntityList) {
      if (entity instanceof EntityNukeDrop) {
        ...
        render(nuke, nuke.prevPosX + (nuke.posX - nuke.prevPosX) * event.partialTicks,
            nuke.prevPosY + (nuke.posY - nuke.prevPosY) * event.partialTicks,
            nuke.prevPosZ + (nuke.posZ - nuke.prevPosZ) * event.partialTicks, 0F,
            event.partialTicks);
      }
    }
