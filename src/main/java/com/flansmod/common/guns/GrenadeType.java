...
public class GrenadeType extends ShootableType {
  ...
  //Physics
  /**
   * Upon hitting a block or entity, the grenade will be deflected and its motion will be multiplied
   * by this constant
   */
  ...
  /**
   * If true, then the grenade will stick to the player that threw it. Used to make delayed self
   * destruct weapons
   */
  ...
  /**
   * If > 0 this will act like a mine and explode when a living entity comes within this radius of
   * the grenade
   */
  public float livingProximityTrigger = -1F;
  /**
   * If > 0 this will act like a mine and explode when a driveable comes within this radius of the
   * grenade
   */
  ...
  /**
   * Whether the grenade should spin when thrown. Generally false for mines or things that should
   * lie flat
   */
  ...
  /**
   * If true, then right clicking this "grenade" will give the player health or buffs or ammo as
   * defined below
   */
  ...
  /**
   * The number of clips to give to the player when using this bag When they right click with a gun,
   * they will get this number of clips for that gun. They get the first ammo type, as listed in the
   * gun type file The number of clips they get is multiplied by numBulletsInGun too TODO : Give
   * guns a "can get ammo from bag" variable. Stops miniguns and such getting ammo
   */
