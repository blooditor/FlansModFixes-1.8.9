...
public class ArmourType extends InfoType {
  ...
  /**
   * The level of the plate added to the armor. 0 = none, 1-5
   */
  public int plateLevel = 1;
  /**
   * The name for the armour texture. Texture path/name is assets/flansmod/armor/<armourTextureName>_1.png
   * or _2 for legs
   */
  ...
  public void read(String[] split, TypeFile file) {
    ...
    try {
      ...
      plateLevel = Read(split, "plateLevel", plateLevel);
