...
public class ModelL96 extends ModelGun {
  ...
  public ModelL96() {
    ...
    ammoModel[0]
        .addShapeBox(3F, -2F, -1F, 3, 2, 2, 0F, /* 0 */ 0F, 1F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */ 0F,
    ...
    barrelAttachPoint = new Vector3f(19.4F / 16F, 4.5F / 16F, 0F / 16F);

    scopeAttachPoint = new Vector3f(-1.5F / 16F, 4.8F / 16F, 0F / 16F);
