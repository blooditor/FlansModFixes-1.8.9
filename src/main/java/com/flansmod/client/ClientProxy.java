      ...
      if (type != null && type.item != null) {
        if (type instanceof PaintableType) {
          for (Paintjob paintjob : ((PaintableType) type).paintjobs) {
            ModelBakery.addVariantName(type.item,
                "flansmod:" + type.shortName + (paintjob.iconName.equals("") ? ""
                    : ("_" + paintjob.iconName)));
            Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
                .register(type.item, paintjob.ID, new ModelResourceLocation(
                    "flansmod:" + type.shortName + (paintjob.iconName.equals("") ? ""
                        : ("_" + paintjob.iconName)), "inventory"));
          }
        } else {
          Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(type.item, 0,
              new ModelResourceLocation("flansmod:" + type.shortName, "inventory"));
        }
      }
    }

    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.workbench), 0,
            new ModelResourceLocation("flansmod:flansWorkbench_guns", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.workbench), 1,
            new ModelResourceLocation("flansmod:flansWorkbench_vehicles", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.workbench), 2,
            new ModelResourceLocation("flansmod:flansWorkbench_parts", "inventory"));
    ModelBakery.addVariantName(Item.getItemFromBlock(FlansMod.workbench),
        "flansmod:flansWorkbench_guns", "flansmod:flansWorkbench_parts",
        "flansmod:flansWorkbench_vehicles");

    Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(FlansMod.opStick, 0,
        new ModelResourceLocation("flansmod:opstick_Ownership", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(FlansMod.opStick, 1,
        new ModelResourceLocation("flansmod:opstick_Connecting", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(FlansMod.opStick, 2,
        new ModelResourceLocation("flansmod:opstick_Mapping", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(FlansMod.opStick, 3,
        new ModelResourceLocation("flansmod:opstick_Destruction", "inventory"));
    ModelBakery.addVariantName(FlansMod.opStick,
        "flansmod:opstick_Ownership", "flansmod:opstick_Connecting",
        "flansmod:opstick_Mapping", "flansmod:opstick_Destruction");

    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.spawner), 0,
            new ModelResourceLocation("flansmod:teamsSpawner_items", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.spawner), 1,
            new ModelResourceLocation("flansmod:teamsSpawner_players", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.spawner), 2,
            new ModelResourceLocation("flansmod:teamsSpawner_vehicles", "inventory"));
    ModelBakery.addVariantName(Item.getItemFromBlock(FlansMod.spawner),
        "flansmod:teamsSpawner_items", "flansmod:teamsSpawner_players",
        "flansmod:teamsSpawner_vehicles");

    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(FlansMod.flag, 0, new ModelResourceLocation("flansmod:flagpole", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(FlansMod.rainbowPaintcan, 0,
            new ModelResourceLocation("flansmod:rainbowPaintcan", "inventory"));
    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
        .register(Item.getItemFromBlock(FlansMod.paintjobTable), 0,
            new ModelResourceLocation("flansmod:paintjobTable", "inventory"));
    ModelBakery.addVariantName(Item.getItemFromBlock(FlansMod.paintjobTable),
        "flansmod:paintjobTable");
...
*/
    ...
    ClientRegistry
        .bindTileEntitySpecialRenderer(TileEntityItemHolder.class, new RenderItemHolder());
  ...
  /**
   * This method reloads all textures from all mods and resource packs. It forces Minecraft to read
   * images from the content packs added after mod init
   */
  @Override
  ...
  /**
   * This method grabs all the content packs and puts them in a list. The client side part registers
   * them as FMLModContainers which adds their resources to the game after a refresh
   */
  @Override
        ...
        try {
          ...
          FMLModContainer container = new FMLModContainer("com.flansmod.common.FlansMod",
              new ModCandidate(file, file,
                  file.isDirectory() ? ContainerType.DIR : ContainerType.JAR), map);
  ...
  public void registerRenderers() {
    ...
    RenderingRegistry
        .registerEntityRenderingHandler(EntityParachute.class, new RenderParachute(rm));
    RenderingRegistry.registerEntityRenderingHandler(EntityDebugDot.class, new RenderDebugDot(rm));
    RenderingRegistry
        .registerEntityRenderingHandler(EntityDebugVector.class, new RenderDebugVector(rm));
    RenderingRegistry
        .registerEntityRenderingHandler(EntityDebugAABB.class, new RenderDebugAABB(rm));
    RenderingRegistry.registerEntityRenderingHandler(EntityMecha.class, new RenderMecha(rm));
    RenderingRegistry.registerEntityRenderingHandler(EntityItemCustomRender.class,
        new RenderGunItem(rm, Minecraft.getMinecraft().getRenderItem(), gunRenderer));

    ClientRegistry
        .bindTileEntitySpecialRenderer(TileEntitySpawner.class, new TileEntitySpawnerRenderer());
  }

  /**
   * Old one time tutorial code that displays messages the first time you enter a plane / vehicle.
   * Needs reworking
   */
  @Override
  ...
  public void changeControlMode(EntityPlayer player) {
    if (FlansModClient.flipControlMode()) {
      player.addChatComponentMessage(new ChatComponentText(
          "Mouse Control mode is now set to " + FlansModClient.controlModeMouse));
    }
  }

  /**
   * Whether the player is in mouse control mode for planes. Now the default setting for planes, but
   * it can be deactivated to look around while flying
   */
  @Override
  ...
  public Object getClientGui(int ID, EntityPlayer player, World world, int x, int y, int z) {
    ...
    switch (ID) {
      ...
      case 5:
        return new GuiGunBox(player.inventory,
            ((BlockGunBox) world.getBlockState(new BlockPos(x, y, z)).getBlock()).type);
      case 6:
        return new GuiDriveableInventory(player.inventory, world,
            ((EntitySeat) player.ridingEntity).driveable, 0);
      case 7:
        return new GuiDriveableInventory(player.inventory, world,
            ((EntitySeat) player.ridingEntity).driveable, 1);
      case 8:
        return new GuiDriveableFuel(player.inventory, world,
      ...
      case 11:
        return new GuiArmourBox(player.inventory,
            ((BlockArmourBox) world.getBlockState(new BlockPos(x, y, z)).getBlock()).type);
      case 12:
        return new GuiDriveableInventory(player.inventory, world,
            ((EntitySeat) player.ridingEntity).driveable, 3);
      case 13:
        return new GuiPaintjobTable(player.inventory, world,
            (TileEntityPaintjobTable) world.getTileEntity(new BlockPos(x, y, z)));
    }
    return null;
  }
  ...
  /**
   * Helper method that sorts out packages with model name input For example, the model class
   * "com.flansmod.client.model.mw.ModelMP5" is referenced in the type file by the string "mw.MP5"
   */
  ...
  /**
   * Generic model loader method for getting model classes and casting them to the required class
   * type
   */
  @Override
  public <T> T loadModel(String s, String shortName, Class<T> typeClass) {
    ...
    try {
      return typeClass
          .cast(Class.forName(modelDir + getModelName(s)).getConstructor().newInstance());
    } catch (Exception e) {
  ...
  /**
   * Checks whether "player" is the current player. Always false on server, since there is no
   * current player
   */
  @Override
  ...
  public boolean keyDown(int keyCode) {
    try {
      ...
      Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(
          "Error while checking for keyCode " + keyCode + ". Please reset your controls"));
      e.printStackTrace();
    }
      ...
      try {
        ...
        if (contentPackDir.isDirectory()) {
          ...
          if (typeToCheckFor == EnumType.armourBox || typeToCheckFor == EnumType.box) {
            ...
            createJSONFile(new File(itemModelsDir, type.shortName + ".json"),
                "{ \"parent\": \"flansmod:block/" + type.shortName
                    + "\", \"display\": { \"thirdperson\": { \"rotation\": [ 10, -45, 170 ], \"translation\": [ 0, 1.5, -2.75 ], \"scale\": [ 0.375, 0.375, 0.375 ] } } }");
            createJSONFile(new File(blockModelsDir, type.shortName + ".json"),
                "{ \"parent\": \"block/cube\", \"textures\": { \"particle\": \"flansmod:blocks/"
                    + box.sideTexturePath +
                    "\", \"down\": \"flansmod:blocks/" + box.bottomTexturePath
                    + "\", \"up\": \"flansmod:blocks/" + box.topTexturePath
                    + "\", \"north\": \"flansmod:blocks/" + box.sideTexturePath +
                    "\", \"east\": \"flansmod:blocks/" + box.sideTexturePath
                    + "\", \"south\": \"flansmod:blocks/" + box.sideTexturePath
                    + "\", \"west\": \"flansmod:blocks/" + box.sideTexturePath + "\" } } ");
            createJSONFile(new File(blockstatesDir, type.shortName + ".json"),
                "{ \"variants\": { \"normal\": { \"model\": \"flansmod:" + type.shortName
                    + "\" } } }");
          } else if (type instanceof PaintableType && type.GetModel() != null) {
            for (Paintjob paintjob : ((PaintableType) type).paintjobs) {
              createJSONFile(new File(itemModelsDir,
                      type.shortName + (paintjob.iconName.equals("") ? "" : ("_" + paintjob.iconName))
                          + ".json"),
                  "{ \"parent\": \"builtin/generated\", \"textures\": { \"layer0\": \"flansmod:items/"
                      + type.iconPath + (paintjob.iconName.equals("") ? ""
                      : ("_" + paintjob.iconName))
            ...
            createJSONFile(new File(blockstatesDir, type.shortName + ".json"),
                "{ \"variants\": { \"facing=north\": { \"model\": \"flansmod:" + type.shortName +
                    ...
                    + "\" } } }");
            createJSONFile(new File(blockModelsDir, type.shortName + ".json"),
                "{ \"ambientocclusion\": false, \"textures\": { \"particle\": \"flansmod:items/"
                    + type.iconPath
                    + "\" }, \"elements\": [ {\"from\": [ 0, 0, 0 ],\"to\": [ 0, 0, 0 ], \"faces\": { \"down\":  { \"texture\": \"#down\", \"cullface\": \"down\" }, \"up\":    { \"texture\": \"#up\", \"cullface\": \"up\" }, \"north\": { \"texture\": \"#north\", \"cullface\": \"north\" }, \"south\": { \"texture\": \"#south\", \"cullface\": \"south\" }, \"west\":  { \"texture\": \"#west\", \"cullface\": \"west\" }, \"east\":  { \"texture\": \"#east\", \"cullface\": \"east\" } } } ] }");
            createJSONFile(new File(itemModelsDir, type.shortName + ".json"),
                "{ \"parent\": \"builtin/generated\", \"textures\": { \"layer0\": \"flansmod:items/"
                    + type.iconPath
          ...
          //Create the item JSON for normal items
            ...
            createJSONFile(new File(itemModelsDir, type.shortName + ".json"),
                "{ \"parent\": \"builtin/generated\", \"textures\": { \"layer0\": \"flansmod:items/"
                    + type.iconPath
                    + "\" }, \"display\": { \"thirdperson\": { \"rotation\": [ 0, 90, -35 ], \"translation\": [ 0, 1.25, -2.5 ], \"scale\": [ 0.85, 0.85, 0.85 ] }, \"firstperson\": { \"rotation\": [ 0, -135, 25 ], \"translation\": [ 0, 4, 2 ], \"scale\": [ 1.7, 1.7, 1.7 ] } } }");
          }
        }
      } catch (Exception e) {
        e.printStackTrace();
