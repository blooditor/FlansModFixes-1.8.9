...
public class ModelSpitfire extends ModelPlane {
  ...
  public ModelSpitfire() {
    ...
    noseModel[0]
        .addTrapezoid(-51F, -16F, -10F, 48, 18, 20, 0.0F, -3.0F, ModelRendererTurbo.MR_RIGHT);
    ...
    rightWingModel[1].addTrapezoid(-25F, 3F, 78F, 32, 2, 10, 0.0F, -1.0F,
        ModelRendererTurbo.MR_BACK);  //Wingtip
    ...
    leftWingModel[1].addTrapezoid(-32F, 3F, -88F, 32, 2, 10, 0.0F, -1.0F,
        ModelRendererTurbo.MR_BACK);  //Wingtip
    ...
    propellerModels[0][0] = new ModelRendererTurbo(this, 192, 12, textureX,
        textureY); //Propeller 0 - Blade 0 : 192, 12 is the texture origin
    propellerModels[0][1] = new ModelRendererTurbo(this, 192, 12, textureX,
        textureY); //Propeller 0 - Blade 1
    propellerModels[0][2] = new ModelRendererTurbo(this, 192, 12, textureX,
