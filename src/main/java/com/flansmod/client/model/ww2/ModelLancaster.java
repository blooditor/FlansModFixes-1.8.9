...
public class ModelLancaster extends ModelPlane {
  ...
  public ModelLancaster() {
    ...
    bodyModel[0].addTrapezoid(-160, -80, -16, 16, 32, 32, 0.0F, -4.0F,
        ModelRendererTurbo.MR_RIGHT); //Front gunner window outside
    bodyModel[18] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
    bodyModel[18].flip = true;
    bodyModel[18].addTrapezoid(-160, -80, -16, 16, 32, 32, 0.0F, -4.0F,
        ModelRendererTurbo.MR_RIGHT); //Front gunner window inside
    ...
    bodyModel[3].addTrapezoid(-128, -96, -16, 64, 16, 32, 0.0F, -8.0F,
        ModelRendererTurbo.MR_TOP); //Pilot window outside
    bodyModel[16] = new ModelRendererTurbo(this, 64, 32, textureX, textureY);
    bodyModel[16].flip = true;
    bodyModel[16].addTrapezoid(-128, -96, -16, 64, 16, 32, 0.0F, -8.0F,
        ModelRendererTurbo.MR_TOP); //Pilot window inside
    ...
    bodyModel[12].addTrapezoid(32, -112, -16, 32, 16, 32, 0.0F, -8.0F,
        ModelRendererTurbo.MR_TOP); //Gunner Window Outside

    bodyModel[17] = new ModelRendererTurbo(this, 144, 279, textureX, textureY);
    bodyModel[17].flip = true;
    bodyModel[17].addTrapezoid(32, -112, -16, 32, 16, 32, 0.0F, -8.0F,
        ModelRendererTurbo.MR_TOP); //Gunner Window Inside
    ...
    bodyModel[13].addShape3D(128, -65, -15,
        new Shape2D(new Coord2D[]{new Coord2D(0, 0, 0, 0), new Coord2D(160, 16, 160, 0),
            new Coord2D(160, 17, 160, 1), new Coord2D(0, 1, 0, 1)}), 30, 160, 1, 322, 30,
        ModelRendererTurbo.MR_FRONT, new float[]{1, 160, 1, 160});
    ...
    bodyModel[14].addShape3D(128, -64, -16,
        new Shape2D(new Coord2D[]{new Coord2D(0, 0, 0, 0), new Coord2D(160, 0, 160, 0),
            new Coord2D(160, 16, 160, 16)}), 1, 160, 16, 336, 1, ModelRendererTurbo.MR_FRONT,
        new float[]{160, 16, 160});
    ...
    tailModel[5].addTrapezoid(128, -96, -16, 16, 32, 32, 0.0F, -6.0F,
        ModelRendererTurbo.MR_LEFT); //Rear Gunner Window Outside
    tailModel[6] = new ModelRendererTurbo(this, 304, 111, textureX, textureY);
    tailModel[6].flip = true;
    tailModel[6].addTrapezoid(128, -96, -16, 16, 32, 32, 0.0F, -6.0F,
        ModelRendererTurbo.MR_LEFT); //Rear Gunner Window Inside
    ...
    leftWingModel[1].addTrapezoid(-64, 112, -82, 80, 128, 4, 0.0F, -2.0F,
        ModelRendererTurbo.MR_BOTTOM); //Right Wing Outer
    leftWingModel[1].rotateAngleX = -(float) Math.PI / 2;
    leftWingModel[2] = new ModelRendererTurbo(this, 256, 32, textureX, textureY);
    leftWingModel[2].addTrapezoid(-112, -80, -64, 64, 24, 24, 0.0F, -2.0F,
        ModelRendererTurbo.MR_BOTTOM); //Right Inner Engine
    leftWingModel[3] = new ModelRendererTurbo(this, 256, 32, textureX, textureY);
    leftWingModel[3].addTrapezoid(-96, -80, -128, 64, 24, 24, 0.0F, -2.0F,
        ModelRendererTurbo.MR_BOTTOM); //Right Outer Engine
    ...
    rightWingModel[1].addTrapezoid(-64, 112, -82, 80, 128, 4, 0.0F, -2.0F,
        ModelRendererTurbo.MR_BOTTOM); //Left Wing Outer
    ...
    rightWingModel[2].addTrapezoid(-112, -80, 40, 64, 24, 24, 0.0F, -2.0F,
        ModelRendererTurbo.MR_BOTTOM); //Left Inner Engine
    rightWingModel[3] = new ModelRendererTurbo(this, 256, 32, textureX, textureY);
    rightWingModel[3].addTrapezoid(-96, -80, 104, 64, 24, 24, 0.0F, -2.0F,
        ModelRendererTurbo.MR_BOTTOM); //Left Outer Engine
