...
public class ModelExoskeletonBody extends ModelCustomArmour {
  ...
  public ModelExoskeletonBody() {
    ...
    bodyModel[9]
        .addShapeBox(-41F, -7F, 11.25F, 19, 4, 4, 0F, -6F, 0F, 9F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F,
            -13F, -6F, 0F, 9F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, -13F); // Box 36
    ...
    bodyModel[21]
        .addShapeBox(22F, -7F, 11.25F, 19, 4, 4, 0F, 0F, 0F, 0F, -6F, 0F, 10F, -1F, 0F, -14F, 0F,
            0F, 0F, 0F, 0F, 0F, -6F, 0F, 10F, -1F, 0F, -14F, 0F, 0F, 0F); // Box 68
    ...
    rightArmModel[0]
        .addBox(-33F + armOffsetX, -39F + armOffsetY, -6F + armOffsetZ, 1, 10, 14, 0F); // Box 26
    rightArmModel[0].setRotationPoint(0F, 0F, -1F);

    rightArmModel[1]
        .addBox(-34F + armOffsetX, -36F + armOffsetY, -4F + armOffsetZ, 1, 10, 2, 0F); // Box 28
    rightArmModel[1].setRotationPoint(0F, 0F, -1F);

    rightArmModel[2]
        .addBox(-33F + armOffsetX, -43F + armOffsetY, -4F + armOffsetZ, 1, 4, 2, 0F); // Box 31
    rightArmModel[2].setRotationPoint(0F, 0F, -1F);

    rightArmModel[3]
        .addBox(-40F + armOffsetX, -74F + armOffsetY, -2F + armOffsetZ, 4, 32, 4, 0F); // Box 34
    rightArmModel[3].setRotationPoint(0F, 0F, 0F);

    rightArmModel[4]
        .addShapeBox(-40F + armOffsetX, -42F + armOffsetY, -2F + armOffsetZ, 4, 16, 4, 0F, 0F, 0F,
            0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -6F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, -6F, 0F,
            0F); // Box 35
    rightArmModel[4].setRotationPoint(0F, 0F, 0F);

    rightArmModel[5]
        .addBox(-33.5F + armOffsetX, -28F + armOffsetY, -8F + armOffsetZ, 16, 3, 18, 0F); // Box 63
    rightArmModel[5].setRotationPoint(0F, 0F, -1F);

    rightArmModel[6]
        .addBox(-34F + armOffsetX, -67F + armOffsetY, -4F + armOffsetZ, 2, 20, 8, 0F); // Box 78
    rightArmModel[6].setRotationPoint(0F, 0F, 0F);

    rightArmModel[7]
        .addBox(-33F + armOffsetX, -72.2F + armOffsetY, -8F + armOffsetZ, 17, 5, 18, 0F); // Box 106
    rightArmModel[7].setRotationPoint(0F, 0F, -5F);

    rightArmModel[8]
        .addBox(-36F + armOffsetX, -62F + armOffsetY, -3F + armOffsetZ, 2, 10, 6, 0F); // Box 114
    rightArmModel[8].setRotationPoint(0F, 0F, 0F);

    rightArmModel[9]
        .addBox(-34F + armOffsetX, -36F + armOffsetY, 0F + armOffsetZ, 1, 10, 2, 0F); // Box 119
    rightArmModel[9].setRotationPoint(0F, 0F, -1F);

    rightArmModel[10]
        .addBox(-33F + armOffsetX, -43F + armOffsetY, 0F + armOffsetZ, 1, 4, 2, 0F); // Box 120
    rightArmModel[10].setRotationPoint(0F, 0F, -1F);

    rightArmModel[11]
        .addBox(-34F + armOffsetX, -36F + armOffsetY, 4F + armOffsetZ, 1, 10, 2, 0F); // Box 121
    rightArmModel[11].setRotationPoint(0F, 0F, -1F);

    rightArmModel[12]
        .addBox(-33F + armOffsetX, -43F + armOffsetY, 4F + armOffsetZ, 1, 4, 2, 0F); // Box 122
    ...
    leftArmModel[0]
        .addBox(16.5F - armOffsetX, -28F + armOffsetY, -8F + armOffsetZ, 16, 3, 18, 0F); // Box 27
    leftArmModel[0].setRotationPoint(0F, 0F, -1F);

    leftArmModel[1]
        .addBox(36F - armOffsetX, -74F + armOffsetY, -2F + armOffsetZ, 4, 32, 4, 0F); // Box 71
    leftArmModel[1].setRotationPoint(0F, 0F, 0F);

    leftArmModel[2]
        .addShapeBox(36F - armOffsetX, -42F + armOffsetY, -2F + armOffsetZ, 4, 16, 4, 0F, 0F, 0F,
            0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 2F, 0F, 0F, -6F, 0F, 0F, -6F, 0F, 0F, 2F, 0F,
            0F); // Box 77
    leftArmModel[2].setRotationPoint(0F, 0F, 0F);

    leftArmModel[3]
        .addBox(32F - armOffsetX, -67F + armOffsetY, -4F + armOffsetZ, 2, 20, 8, 0F); // Box 79
    leftArmModel[3].setRotationPoint(0F, 0F, 0F);

    leftArmModel[4]
        .addBox(16F - armOffsetX, -72.2F + armOffsetY, -8F + armOffsetZ, 17, 5, 18, 0F); // Box 107
    leftArmModel[4].setRotationPoint(0F, 0F, -5F);

    leftArmModel[5]
        .addBox(34F - armOffsetX, -62F + armOffsetY, -3F + armOffsetZ, 2, 10, 6, 0F); // Box 115
    leftArmModel[5].setRotationPoint(0F, 0F, 0F);

    leftArmModel[6]
        .addBox(32F - armOffsetX, -43F + armOffsetY, 4F + armOffsetZ, 1, 4, 2, 0F); // Box 123
    leftArmModel[6].setRotationPoint(0F, 0F, -1F);

    leftArmModel[7]
        .addBox(32F - armOffsetX, -43F + armOffsetY, 0F + armOffsetZ, 1, 4, 2, 0F); // Box 124
    leftArmModel[7].setRotationPoint(0F, 0F, -1F);

    leftArmModel[8]
        .addBox(32F - armOffsetX, -43F + armOffsetY, -4F + armOffsetZ, 1, 4, 2, 0F); // Box 125
    leftArmModel[8].setRotationPoint(0F, 0F, -1F);

    leftArmModel[9]
        .addBox(32F - armOffsetX, -39F + armOffsetY, -6F + armOffsetZ, 1, 10, 14, 0F); // Box 126
    leftArmModel[9].setRotationPoint(0F, 0F, -1F);

    leftArmModel[10]
        .addBox(33F - armOffsetX, -36F + armOffsetY, 4F + armOffsetZ, 1, 10, 2, 0F); // Box 127
    leftArmModel[10].setRotationPoint(0F, 0F, -1F);

    leftArmModel[11]
        .addBox(33F - armOffsetX, -36F + armOffsetY, 0F + armOffsetZ, 1, 10, 2, 0F); // Box 128
    leftArmModel[11].setRotationPoint(0F, 0F, -1F);

    leftArmModel[12]
        .addBox(33F - armOffsetX, -36F + armOffsetY, -4F + armOffsetZ, 1, 10, 2, 0F); // Box 129
