...
public class ModelKV1 extends ModelVehicle //Same as Filename
{
  ...
  public ModelKV1() //Same as Filename
  {
    ...
    bodyModel[6] = new ModelRendererTurbo(this, 0, 360, textureX,
        textureY); // Import CR,LeftTrackCover
    bodyModel[7] = new ModelRendererTurbo(this, 0, 360, textureX,
        textureY); // Import CR,rightTrackCover
    bodyModel[8] = new ModelRendererTurbo(this, 350, 0, textureX,
        textureY); // Import CR,FrontRightWheel
    bodyModel[9] = new ModelRendererTurbo(this, 350, 50, textureX,
        textureY); // Import CR,BackRightWheel
    bodyModel[10] = new ModelRendererTurbo(this, 350, 150, textureX,
        textureY); // Import CR,RightTopWheel1
    bodyModel[11] = new ModelRendererTurbo(this, 350, 150, textureX,
        textureY); // Import CR,RightTopWheel2
    bodyModel[12] = new ModelRendererTurbo(this, 350, 150, textureX,
        textureY); // Import CR,RightTopWheel3
    bodyModel[13] = new ModelRendererTurbo(this, 350, 0, textureX,
        textureY); // Import CR,FrontLeftWheel
    bodyModel[14] = new ModelRendererTurbo(this, 350, 50, textureX,
        textureY); // Import CR,BackLeftWheel
    bodyModel[15] = new ModelRendererTurbo(this, 350, 150, textureX,
        textureY); // Import CR,LeftTopWheel1
    bodyModel[16] = new ModelRendererTurbo(this, 350, 150, textureX,
        textureY); // Import CR,LeftTopWheel2
    bodyModel[17] = new ModelRendererTurbo(this, 350, 150, textureX,
        textureY); // Import CR,LeftTopWheel3
    ...
    bodyModel[24] = new ModelRendererTurbo(this, 350, 275, textureX,
        textureY); // Import RT,BottomThread
    bodyModel[25] = new ModelRendererTurbo(this, 350, 300, textureX,
        textureY); // Import RT,FrontCornerThread
    bodyModel[26] = new ModelRendererTurbo(this, 350, 320, textureX,
        textureY); // Import RT,FrontThread
    bodyModel[27] = new ModelRendererTurbo(this, 350, 350, textureX,
        textureY); // Import RT,TopThread
    bodyModel[28] = new ModelRendererTurbo(this, 350, 370, textureX,
        textureY); // Import RT,BackThread
    bodyModel[29] = new ModelRendererTurbo(this, 350, 400, textureX,
        textureY); // Import RT,BackCornerThread
    ...
    bodyModel[36] = new ModelRendererTurbo(this, 350, 275, textureX,
        textureY); // Import LT,BottomThread
    bodyModel[37] = new ModelRendererTurbo(this, 350, 300, textureX,
        textureY); // Import LT,FrontCornerThread
    bodyModel[38] = new ModelRendererTurbo(this, 350, 320, textureX,
        textureY); // Import LT,FrontThread
    bodyModel[39] = new ModelRendererTurbo(this, 350, 350, textureX,
        textureY); // Import LT,TopThread
    bodyModel[40] = new ModelRendererTurbo(this, 350, 370, textureX,
        textureY); // Import LT,BackThread
    bodyModel[41] = new ModelRendererTurbo(this, 350, 400, textureX,
        textureY); // Import LT,BackCornerThread
    bodyModel[42] = new ModelRendererTurbo(this, 350, 600, textureX,
        textureY); // Import CR,RightTrackDetail1
    bodyModel[43] = new ModelRendererTurbo(this, 350, 600, textureX,
        textureY); // Import CR,RightTrackDetail2
    bodyModel[44] = new ModelRendererTurbo(this, 350, 650, textureX,
        textureY); // Import CR,RightTrackDetail3
    bodyModel[45] = new ModelRendererTurbo(this, 350, 600, textureX,
        textureY); // Import CR,RightTrackDetail2
    bodyModel[46] = new ModelRendererTurbo(this, 350, 700, textureX,
        textureY); // Import CR,LeftTrackDetail1
    bodyModel[47] = new ModelRendererTurbo(this, 350, 700, textureX,
        textureY); // Import CR,LeftTrackDetail2
    bodyModel[48] = new ModelRendererTurbo(this, 350, 750, textureX,
        textureY); // Import CR,LeftTrackDetail3
    bodyModel[49] = new ModelRendererTurbo(this, 350, 700, textureX,
        textureY); // Import CR,LeftTrackDetail4
    ...
    turretModel[0] = new ModelRendererTurbo(this, 500, 0, textureX,
        textureY); // Import TR,TurretSpinny
    turretModel[1] = new ModelRendererTurbo(this, 500, 75, textureX,
        textureY); // Import TR,MainPart
    turretModel[2] = new ModelRendererTurbo(this, 500, 120, textureX,
        textureY); // Import TR,RightCheeck
    turretModel[3] = new ModelRendererTurbo(this, 500, 150, textureX,
        textureY); // Import TR,LeftCheeck
    turretModel[4] = new ModelRendererTurbo(this, 500, 180, textureX,
        textureY); // Import TR,FrontAngle
    turretModel[5] = new ModelRendererTurbo(this, 600, 180, textureX,
        textureY); // Import BL,GunBase
    ...
    barrelModel[0] = new ModelRendererTurbo(this, 600, 150, textureX,
        textureY); // Import BL,Gunthingy
    barrelModel[1] = new ModelRendererTurbo(this, 600, 120, textureX, textureY); // Import BL,75MM

    barrelModel[0]
        .addShapeBox(1F, -2F, -2F, 12, 5, 4, 0F, 3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F,
            0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 3F, 0F, 0F); // Import BL,Gunthingy
