...
public class ModelZero extends ModelPlane {
  ...
  public ModelZero() {
    ...
    tailModel[2] = new ModelRendererTurbo(this, 180, 235, textureX,
    ...
    pitchFlapLeftModel[1] = new ModelRendererTurbo(this, 200, 430, textureX,
    ...
    pitchFlapRightModel[1] = new ModelRendererTurbo(this, 200, 430, textureX,
    ...
    pitchFlapLeftWingModel[0] = new ModelRendererTurbo(this, 0, 220, textureX,
...
// Pitch Flap Right Wing
    ...
    pitchFlapRightWingModel[0] = new ModelRendererTurbo(this, 0, 220, textureX,
    ...
    leftWingWheelModel[2] = new ModelRendererTurbo(this, 0, 360, textureX,
        textureY); // LGLWWheelCover
...
// Right Wing Wheel
    ...
    rightWingWheelModel[2] = new ModelRendererTurbo(this, 0, 360, textureX,
        textureY); // LGRW.WheelCover
