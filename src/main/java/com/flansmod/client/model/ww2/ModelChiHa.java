...
// Body
    ...
    bodyModel[7] = new ModelRendererTurbo(this, 50, 850, textureX,
        textureY); // CR.RightTrackTopRight
    bodyModel[8] = new ModelRendererTurbo(this, 50, 850, textureX,
    ...
    bodyModel[11] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelrightfront
    bodyModel[12] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelrightcenter
    bodyModel[13] = new ModelRendererTurbo(this, 0, 720, textureX,
    ...
    bodyModel[17] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelleftfront
    bodyModel[18] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelleftcenter
    bodyModel[19] = new ModelRendererTurbo(this, 0, 720, textureX,
