...
// Body
    ...
    bodyModel[3] = new ModelRendererTurbo(this, 50, 460, textureX,
        textureY); // CR.FrontArmorPlateBottom
    bodyModel[4] = new ModelRendererTurbo(this, 50, 510, textureX,
        textureY); // CR.FrontArmorPlateRight
    bodyModel[5] = new ModelRendererTurbo(this, 100, 510, textureX,
        textureY); // CR.FrontArmorPlateLeft
    bodyModel[6] = new ModelRendererTurbo(this, 50, 570, textureX,
        textureY); // CR.FrontArmorPlateRight
    ...
    bodyModel[13] = new ModelRendererTurbo(this, 150, 800, textureX,
        textureY); // CR.AmmoSquarePegRight
    bodyModel[14] = new ModelRendererTurbo(this, 150, 800, textureX,
        textureY); // CR.AmmoSquarePegLeft
    bodyModel[15] = new ModelRendererTurbo(this, 50, 850, textureX,
        textureY); // CR.RightTrackTopRight
    bodyModel[16] = new ModelRendererTurbo(this, 50, 850, textureX,
        textureY); // CR.RightTrackTopLeft
    bodyModel[17] = new ModelRendererTurbo(this, 50, 870, textureX, textureY); // CR.ArmorRightSide
    bodyModel[18] = new ModelRendererTurbo(this, 100, 870, textureX,
        textureY); // CR.ArmorRightSideBack
    bodyModel[19] = new ModelRendererTurbo(this, 50, 870, textureX, textureY); // CR.ArmorLeftSide
    bodyModel[20] = new ModelRendererTurbo(this, 100, 870, textureX,
        textureY); // CR.ArmorLeftSideBack
    ...
    bodyModel[28] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelrightfront
    bodyModel[29] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelrightcenter
    bodyModel[30] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelrightback
    ...
    bodyModel[34] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelleftfront
    bodyModel[35] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelleftcenter
    bodyModel[36] = new ModelRendererTurbo(this, 0, 720, textureX,
        textureY); // CR.miniwheelleftback
...
// Barrel
    ...
    barrelModel[2] = new ModelRendererTurbo(this, 250, 450, textureX,
        textureY); // BL.WormBrainthing
...
// Left Track
    ...
    leftTrackModel[10] = new ModelRendererTurbo(this, 600, 530, textureX,
        textureY); // LT.Frontcorner
    leftTrackModel[11] = new ModelRendererTurbo(this, 600, 570, textureX,
        textureY); // LT.Backcorner
...
// Right Track
    ...
    rightTrackModel[10] = new ModelRendererTurbo(this, 600, 530, textureX,
        textureY); // RT.Frontcorner
    rightTrackModel[11] = new ModelRendererTurbo(this, 600, 570, textureX,
        textureY); // RT.Backcorner
