...
public class AttachmentType extends PaintableType implements IScope {
  ...
  /**
   * The type of attachment. Each gun can have one barrel, one scope, one grip, one stock and some
   * number of generics up to a limit set by the gun
   */
  ...
  /**
   * If set to anything other than null, then this attachment will override the weapon's default
   * firing mode
   */
