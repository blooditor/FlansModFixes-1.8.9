...
public class BiomeGenApocalypse extends BiomeGenBase {
  ...
  protected static final BiomeGenBase.Height height_HighPlateau = new BiomeGenBase.Height(2.5F,
      0.F);
  ...
  public static void registerBiomes() {
    deepCanyon = (new BiomeGenDesertCanyon(240, true)).setColor(6316128).setBiomeName("Deep Canyon")
        .setHeight(height_DeepCanyon).setDisableRain().setTemperatureRainfall(2F, 0F);
    canyon = (new BiomeGenDesertCanyon(241, true)).setColor(6316128).setBiomeName("Canyon")
        .setHeight(height_Canyon).setDisableRain().setTemperatureRainfall(2F, 0F);
    desert = (new BiomeGenDesertCanyon(242, true)).setColor(6316128).setBiomeName("Desert")
        .setHeight(height_Ground).setDisableRain().setTemperatureRainfall(2F, 0F);
    plateau = (new BiomeGenDesertCanyon(243, true)).setColor(6316128).setBiomeName("Plateau")
        .setHeight(height_Plateau).setDisableRain().setTemperatureRainfall(2F, 0F);
    highPlateau = (new BiomeGenDesertCanyon(244, true)).setColor(6316128)
        .setBiomeName("High Plateau").setHeight(height_HighPlateau).setDisableRain()
        .setTemperatureRainfall(2F, 0F);

    sulphurPits = (new BiomeGenSulphurPits(245, true)).setColor(6316128)
        .setBiomeName("Sulphur Pits").setHeight(height_DeepCanyon).setDisableRain()
        .setTemperatureRainfall(2F, 0F);
  ...
  @Override
  public void genTerrainBlocks(World worldIn, Random p_180622_2_, ChunkPrimer p_180622_3_,
      int p_180622_4_, int p_180622_5_, double p_180622_6_) {
    this.generateBiomeTerrainSandy(worldIn, p_180622_2_, p_180622_3_, p_180622_4_, p_180622_5_,
        p_180622_6_);
  }

  public final void generateBiomeTerrainSandy(World world, Random rand, ChunkPrimer primer, int x,
      int z, double p_180628_6_) {
    boolean flag = true;
