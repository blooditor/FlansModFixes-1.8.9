...
public class ItemOpStick extends Item implements IFlanItem {
  ...
  public static final String[] teamNames = new String[]{"No Team", "Spectators", "Team 1",
      "Team 2"};
  ...
  public static void openBaseEditGUI(ITeamBase base, EntityPlayerMP player) {
    ...
    FlansMod.getPacketHandler().sendTo(
        new PacketBaseEdit(base.getBaseID(), base.getBaseName(), maps, currentMapID,
            base.getDefaultOwnerID()), player);
