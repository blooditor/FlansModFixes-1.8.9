...
public class BulletType extends ShootableType {
  ...
  public enum AmmoType {
    ...
    C50(".50 BMG", ".50", 858, 0.94f, 2.2f, 0.7f, 1.8f), //barrett
    ...
    C300(".300 AAC Blackout", ".300aac", 420, 0.01f, 3.5f, 1.05f, 0.8f), //honeybadger
    ...
    SHELL_FAST("Shell", "shell_fast", 350, 0.90f, 3f, 1f, 3f, 2),
    //   MM30("30mm", "30mm", 1010f, 0.90f, 3f, 1f, 3f),
