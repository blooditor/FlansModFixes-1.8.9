...
public class ItemBullet extends ItemShootable implements IFlanItem {
  ...
  public EntityShootable getEntity(World worldObj, Vec3 origin, float yaw,
    ...
    return new EntityBullet(worldObj, origin, yaw, pitch, motionX, motionY, motionZ, shooter,
        gunDamage, this.type, shotFrom);
  }
  ...
  public EntityShootable getEntity(World worldObj, Vector3f origin, Vector3f direction,
    ...
    return new EntityBullet(worldObj, origin, direction, shooter, spread, damage, this.type, speed,
        shotFrom);
  }
  ...
  public EntityShootable getEntity(World worldObj, EntityLivingBase player,
    ...
    return new EntityBullet(worldObj, player, bulletSpread, damage, this.type, bulletSpeed,
        isShotgun, shotFrom);
  }
  ...
  @Override
  public EntityShootable Shoot(World world, Vector3f origin, Vector3f direction,
      float damageModifier, float spreadModifier, float speedModifier, InfoType shotFrom,
      EntityLivingBase shooter) {
    EntityShootable e = getEntity(world, shooter, spreadModifier, damageModifier, speedModifier,
        false, shotFrom);
