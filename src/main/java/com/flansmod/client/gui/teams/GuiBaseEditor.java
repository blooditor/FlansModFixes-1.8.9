...
public class GuiBaseEditor extends GuiScreen {
  ...
  /**
   * The packet received from the server containing all the base information. Modify this and send
   * it back
   */
  ...
  public void initGui() {
    ...
    nameEntryField = new GuiTextField(0, this.fontRendererObj, width / 2 - 128 + 70,
        height / 2 - 94 + 24, 179, fontRendererObj.FONT_HEIGHT);
    ...
    teamButtons[1] = new GuiButton(1, width / 2 - 128 + 68, height / 2 - 94 + 38, 58, 20,
        "Spectator");
    teamButtons[2] = new GuiButton(2, width / 2 - 128 + 130, height / 2 - 94 + 38, 58, 20,
        "Team 1");
    teamButtons[3] = new GuiButton(3, width / 2 - 128 + 192, height / 2 - 94 + 38, 58, 20,
        "Team 2");
    ...
    for (int i = 0; i < 5; i++) {
      mapButtons[i] = new GuiButton(4 + i, width / 2 - 128 + 28, height / 2 - 94 + 75 + 22 * i, 200,
          20, "Map " + (i + 1));
