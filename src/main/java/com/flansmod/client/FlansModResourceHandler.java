...
public class FlansModResourceHandler {
  ...
  public static ResourceLocation[] opStick = new ResourceLocation[]{
      new ResourceLocation("flansmod", "textures/items/opStick_ownership.png"),
      new ResourceLocation("flansmod", "textures/items/opStick_connecting.png"),
      new ResourceLocation("flansmod", "textures/items/opStick_mapping.png"),
  ...
  public static ResourceLocation getIcon(InfoType infoType) {
    ...
    ResourceLocation resLoc = new ResourceLocation("flansmod",
        "textures/items/" + infoType.iconPath + ".png");
  ...
  public static ResourceLocation getDeployableTexture(GunType gunType) {
    ...
    ResourceLocation resLoc = new ResourceLocation("flansmod",
        "skins/" + gunType.deployableTexture + ".png");
  ...
  public static ResourceLocation getPaintjobTexture(Paintjob paintjob) {
    ...
    ResourceLocation resLoc = new ResourceLocation("flansmod",
        "skins/" + paintjob.textureName + ".png");
  ...
  public static ResourceLocation getIcon(PaintableType paintableType, Paintjob paintjob) {
    ...
    ResourceLocation resLoc = new ResourceLocation("flansmod",
        "textures/items/" + paintjob.iconName + ".png");
  ...
  public static ResourceLocation getTrailTexture(BulletType bulletType) {
    ...
    ResourceLocation resLoc = new ResourceLocation("flansmod",
        "skins/" + bulletType.trailTexture + ".png");
  ...
  public static boolean HasResourceForHash(int customPaintHash) {
    return customPaintjobSkins.containsKey(customPaintHash) && customPaintjobIcons
        .containsKey(customPaintHash);
  }

  public static void CreateSkinResourceFromByteArray(byte[] byteArray, int textureWidth,
      int textureHeight, int customPaintHash) {
    ...
    try {
      ...
      WritableRaster raster = Raster.createInterleavedRaster(buffer, textureWidth, textureHeight,
          BYTES_PER_PIXEL * textureWidth, BYTES_PER_PIXEL, new int[]{0, 1, 2}, null);
  ...
  public static void CreateIconResourceFromByteArray(byte[] byteArray, int textureWidth,
      int textureHeight, int customPaintHash) {
    ...
    try {
      ...
      WritableRaster raster = Raster.createInterleavedRaster(buffer, textureWidth, textureHeight,
          BYTES_PER_PIXEL * textureWidth, BYTES_PER_PIXEL, new int[]{0, 1, 2, 3}, null);
      ColorModel cm = new ComponentColorModel(ColorModel.getRGBdefault().getColorSpace(), false,
          true, Transparency.OPAQUE, DataBuffer.TYPE_BYTE);
      BufferedImage image = new BufferedImage(cm, raster, true, null);
