...
public class ItemMecha extends Item implements IPaintableItem {
  ...
  public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
    ...
    if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
      ...
      if (!world.isRemote) {
        world.spawnEntityInWorld(new EntityMecha(world, (double) pos.getX() + 0.5F,
            (double) pos.getY() + 1.5F + type.yOffset, (double) pos.getZ() + 0.5F, entityplayer,
            type, getData(itemstack, world), getTagCompound(itemstack, world)));
      }
