    ...
    try {
      ...
      if (spawnerTeam == null || !currentMap) {
        switch (spawnerTeamID) {
          case 0:
            return 0x808080;  //No team : light grey
          case 1:
            return 0x404040;  //Spectators : dark grey
          case 2:
            return 0xa17fff;  //Team 1 : purple
          case 3:
            return 0xff7fb6;  //Team 2 : pink
        }
      }
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
    ...
    if (MinecraftServer.getServer().getConfigurationManager()
      ...
      if (item == null || item.getItem() == null) {
        ...
        player
            .addChatMessage(new ChatComponentText("Set spawn delay to " + spawner.spawnDelay / 20));
