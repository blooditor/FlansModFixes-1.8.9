...
public class ModelM249 extends ModelGun {
  ...
  public ModelM249() {
    ...
    defaultStockModel[0] = new ModelRendererTurbo(this, 20, 11, textureX,
        textureY); // defaultstock1
    defaultStockModel[1] = new ModelRendererTurbo(this, 24, 11, textureX,
        textureY); // defaultstock2
