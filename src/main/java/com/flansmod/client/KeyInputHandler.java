...
public class KeyInputHandler {
 ...
 // public static KeyBinding gunKey = new KeyBinding("Gun Key", Keyboard.KEY_NONE, "Flan's Mod");
  ...
  public static KeyBinding flareKey = new KeyBinding("Flare Key", Keyboard.KEY_V, "Flan's Mod");
  ...
  public static KeyBinding rightRollKey = new KeyBinding("Roll Right Key", Keyboard.KEY_X,
      "Flan's Mod");
  public static KeyBinding gearKey = new KeyBinding("Gear Up / Down Key", Keyboard.KEY_L,
      "Flan's Mod");
  ...
  public static KeyBinding reloadModelsKey = new KeyBinding("Reload Models Key", Keyboard.KEY_F9,
      "Flan's Mod");
 ...
 //   ClientRegistry.registerKeyBinding(gunKey);
  ...
  public void CheckKeyInput(KeyInputEvent event) {
    ...
    if (reloadKey.isPressed()) {
      ...
      if (data.shootTimeRight <= 0.0f && data.reloadingRight == 0) {
