...
public abstract class ModelPoolEntry {
  ...
  public File checkValidPath(String path) {
    ...
    for (int index = 0; index < fileExtensions.length && (file == null || !file.exists());
        index++) {
      String absPath = path;
  ...
  protected void applyGroups(Map<String, TransformGroup> groupsMap,
      Map<String, TextureGroup> texturesMap) {
