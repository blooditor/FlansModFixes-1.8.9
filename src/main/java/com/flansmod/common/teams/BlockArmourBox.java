...
public class BlockArmourBox extends Block {
  ...
  public void buyArmour(String shortName, int piece, InventoryPlayer inventory) {
    ...
    CraftingInstance crafting = new CraftingInstance(inventory, entryPicked.requiredStacks[piece],
        resultStack);
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
      EntityPlayer entityplayer, EnumFacing side, float par7, float par8, float par9) {
