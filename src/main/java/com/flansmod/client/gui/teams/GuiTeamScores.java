...
public class GuiTeamScores extends GuiTeamsBase {
  ...
  public static final ResourceLocation texture = new ResourceLocation("flansmod",
      "gui/teamsScores.png");
  public static final ResourceLocation texture2 = new ResourceLocation("flansmod",
      "gui/teamsScores2.png");
  ...
  public void drawScreen(int i, int j, float f) {
    ...
    if (teamInfo == null || teamInfo.gametype == null || teamInfo.gametype.equals("")
        || teamInfo.teamData == null || teamInfo.teamData.length < 1) {
  ...
  public void renderTwoTeamGUI(PacketTeamInfo teamInfo) {
    ...
    drawModalRectWithCustomSizedTexture(m, n + 65 + (teamInfo.numLines) * 16, 100, 170, 312, 10,
        512, 256);
    ...
    drawString(fontRendererObj, teamInfo.gametype,
        m + 312 - 6 - fontRendererObj.getStringWidth(teamInfo.gametype), n + 6, 0xffffff);
    ...
    if (teamInfo.roundOver()) {
      ...
      drawString(fontRendererObj, Math.max(ClientTeamsData.timeLeftInStage / 20, 0) + "",
          m + 312 - 22, n + 20, 0xffffff);
      ...
      drawString(fontRendererObj,
          "Time Left : " + minutesLeft + ":" + (secondsLeft < 10 ? "0" + secondsLeft : secondsLeft),
          m + 10, n + 20, 0xffffff);
      drawString(fontRendererObj, "Score Limit : " + teamInfo.scoreLimit,
          m + 302 - fontRendererObj.getStringWidth("Score Limit : " + teamInfo.scoreLimit), n + 20,
          0xffffff);
    }

    for (int i = 0; i < 2; i++) {
      fontRendererObj.drawString(
          "\u00a7" + teamInfo.teamData[i].team.textColour + teamInfo.teamData[i].team.name,
          m + 10 + 151 * i, n + 39, 0xffffff);
      fontRendererObj
          .drawString("\u00a7" + teamInfo.teamData[i].team.textColour + teamInfo.teamData[i].score,
              m + 133 + 151 * i, n + 39, 0xffffff);
      for (int j = 0; j < teamInfo.teamData[i].numPlayers; j++) {
        if (teamInfo.teamData[i].playerData[j] == null) {
          continue;
        }
        GlStateManager.color(1.0f, 1.0f, 1.0f);
        DrawRankIcon(teamInfo.teamData[i].playerData[j].level, 0, m + 10 + 151 * i, n + 65 + 16 * j,
            false);
        drawString(fontRendererObj, teamInfo.teamData[i].playerData[j].username, m + 30 + 151 * i,
            n + 68 + 16 * j, 0xffffff);
        drawCenteredString(fontRendererObj, "" + teamInfo.teamData[i].playerData[j].score,
            m + 111 + 151 * i, n + 68 + 16 * j, 0xffffff);
        drawCenteredString(fontRendererObj,
            "" + (teamInfo.showZombieScore ? teamInfo.teamData[i].playerData[j].zombieScore
                : teamInfo.teamData[i].playerData[j].kills), m + 127 + 151 * i, n + 68 + 16 * j,
            0xffffff);
        drawCenteredString(fontRendererObj, "" + teamInfo.teamData[i].playerData[j].deaths,
            m + 143 + 151 * i, n + 68 + 16 * j, 0xffffff);
      }
    }
  ...
  public void renderDMGUI(PacketTeamInfo teamInfo) {
    ...
    if (teamInfo.sortedByTeam) {
      for (int p = 0; p < teamInfo.numTeams; p++) {
        ...
        drawString(fontRendererObj,
            "\u00a7" + teamInfo.teamData[p].team.textColour + teamInfo.teamData[p].team.name, m + 8,
            n + 25 + 9 * line, 0xffffff);
        drawString(fontRendererObj, "" + teamInfo.teamData[p].score, m + 100, n + 25 + 9 * line,
            0xffffff);
        line++;
        for (int q = 0; q < teamInfo.teamData[p].numPlayers; q++) {
          drawString(fontRendererObj, teamInfo.teamData[p].playerData[q].username, m + 8,
              n + 25 + 9 * line, 0xffffff);
          drawString(fontRendererObj, "" + teamInfo.teamData[p].playerData[q].score, m + 100,
              n + 25 + 9 * line, 0xffffff);
          drawString(fontRendererObj, "" + teamInfo.teamData[p].playerData[q].kills, m + 150,
              n + 25 + 9 * line, 0xffffff);
          drawString(fontRendererObj, "" + teamInfo.teamData[p].playerData[q].deaths, m + 200,
              n + 25 + 9 * line, 0xffffff);
          line++;
        }
      }
      ...
      for (int q = 0; q < teamInfo.teamData[0].numPlayers; q++) {
        drawString(fontRendererObj, teamInfo.teamData[0].playerData[q].username, m + 8,
            n + 25 + 9 * line, 0xffffff);
        drawString(fontRendererObj, "" + teamInfo.teamData[0].playerData[q].score, m + 100,
            n + 25 + 9 * line, 0xffffff);
        drawString(fontRendererObj, "" + teamInfo.teamData[0].playerData[q].kills, m + 150,
            n + 25 + 9 * line, 0xffffff);
        drawString(fontRendererObj, "" + teamInfo.teamData[0].playerData[q].deaths, m + 200,
            n + 25 + 9 * line, 0xffffff);
        line++;
      }
    }
