...
public class ModelVehicle extends ModelDriveable {
  ...
  public void render(float f5, EntityVehicle vehicle, float f) {
    ...
    for (EntitySeat seat : vehicle.seats) {
      ...
      if (seat != null && seat.seatInfo != null && seat.seatInfo.gunName != null
          && gunModels.get(seat.seatInfo.gunName) != null && vehicle
          .isPartIntact(seat.seatInfo.part) && !vehicle.rotateWithTurret(seat.seatInfo)) {
        float yaw =
   ...
   * @param dt
   */
  public void renderTurret(float f, float f1, float f2, float f3, float f4, float f5,
      EntityVehicle vehicle, float dt) {
    ...
    for (EntitySeat seat : vehicle.seats) {
      ...
      if (seat != null && seat.seatInfo != null && seat.seatInfo.gunName != null
        ...
        float yaw =
            seat.prevLooking.getYaw() + (seat.looking.getYaw() - seat.prevLooking.getYaw()) * dt;
        float pitch = seat.prevLooking.getPitch()
