...
public class ModelBarrett extends ModelGun {
  ...
  public ModelBarrett() {
    ...
    gunModel[9]
        .addShapeBox(6F, 0F, -1F, 6, 2, 2, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F,
            -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F); // Box 6
    ...
    defaultScopeModel[0]
        .addTrapezoid(-1F, 4.25F, -1F, 4, 2, 2, 0F, -0.5F, ModelRendererTurbo.MR_LEFT);

    defaultScopeModel[1] = new ModelRendererTurbo(this, 12, 10, textureX, textureY);
    defaultScopeModel[1]
        .addTrapezoid(3F, 4.25F, -1F, 4, 2, 2, 0F, -0.5F, ModelRendererTurbo.MR_RIGHT);
