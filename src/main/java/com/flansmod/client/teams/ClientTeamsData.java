...
public class ClientTeamsData {
  ...
  public static void Tick() {
    ...
    if (stage != RoundFinishedStage.NOT_FINISHED
  ...
  public static void StartTimers() {
    ...
    timeLeftTotal = roundFinishedData.scoresTime + roundFinishedData.rankUpdateTime
        + roundFinishedData.votingTime;
  ...
  public static void OpenRewardBox(int i) {
    ...
    FMLClientHandler.instance().getClient()
        .displayGuiScreen(new GuiOpenRewardBox(currentPool.rewardBoxes[i]));
  }
