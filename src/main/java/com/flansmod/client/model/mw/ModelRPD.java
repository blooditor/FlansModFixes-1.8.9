...
public class ModelRPD extends ModelGun {
  ...
  public ModelRPD() {
    ...
    gunModel[1]
        .addShapeBox(7F, 3F, -1F, 2, 2, 2, 0F, /* 0 */ 0F, 0.2F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */ 0F,
            0F, 0F, /* 3 */ 0F, 0.2F, 0F, /* 4 */ 0F, 0.2F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            0F, /* 7 */ 0F, 0.2F, 0F);

    gunModel[2] = new ModelRendererTurbo(this, 28, 0, textureX, textureY);
    gunModel[2]
        .addShapeBox(9F, 3F, -1F, 2, 2, 2, 0F, /* 0 */ 0F, 0F, 0F, /* 1 */ 0F, 0.2F, 0F, /* 2 */ 0F,
            0.2F, 0F, /* 3 */ 0F, 0F, 0F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0.2F, 0F, /* 6 */ 0F,
            0.2F, 0F, /* 7 */ 0F, 0F, 0F);
    ...
    ammoModel[1].addShapeBox(4F, -1F, -3F, 2, 5, 2, 0F, /* 0 */ 0F, -1.5F, -0.5F, /* 1 */ 0F, -1.5F,
        -0.5F, /* 2 */ 0F, 0F, 0F, /* 3 */ 0F, 0F, 0F, /* 4 */ 0F, -1.5F, -0.5F, /* 5 */ 0F, -1.5F,
        -0.5F, /* 6 */ 0F, 0F, 0F, /* 7 */ 0F, 0F, 0F);

    ammoModel[2] = new ModelRendererTurbo(this, 16, 6, textureX, textureY);
    ammoModel[2]
        .addShapeBox(4F, -1F, 1F, 2, 5, 2, 0F, /* 0 */ 0F, 0F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */ 0F,
    ...
    defaultStockModel[0]
        .addShapeBox(-2F, 3F, -1F, 1, 2, 2, 0F, /* 0 */ 0F, 1F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */ 0F,
            0F, 0F, /* 3 */ 0F, 1F, 0F, /* 4 */ 0F, -1F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            0F, /* 7 */ 0F, -1F, 0F);

    defaultStockModel[1] = new ModelRendererTurbo(this, 42, 12, textureX, textureY);
    defaultStockModel[1]
        .addShapeBox(-5F, 2F, -1F, 3, 2, 2, 0F, /* 0 */ 0F, 1F, 0F, /* 1 */ 0F, 0F, 0F, /* 2 */ 0F,
            0F, 0F, /* 3 */ 0F, 1F, 0F, /* 4 */ 0F, 0F, 0F, /* 5 */ 0F, 0F, 0F, /* 6 */ 0F, 0F,
            0F, /* 7 */ 0F, 0F, 0F);
