...
public class ModelFlagpole extends ModelBase {
  ...
  public void renderPole(float f, float f1, float f2, float f3, float f4, float f5,
      EntityFlagpole entityflag) {
    for (ModelRenderer model : poleModel) {
      model.render(f5);
    }
  }

  public void renderFlag(float f, float f1, float f2, float f3, float f4, float f5,
