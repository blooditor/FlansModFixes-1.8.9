...
public enum EnumMechaItemType {
  ...
  public EnumMechaSlotType[] getValidSlots() {
    switch (this) {
      case upgrade:
        return new EnumMechaSlotType[]{EnumMechaSlotType.u1, EnumMechaSlotType.u2,
            EnumMechaSlotType.u3, EnumMechaSlotType.u4, EnumMechaSlotType.u5};
      case tool:
      ...
      case shoulderUpgrade:
        return new EnumMechaSlotType[]{EnumMechaSlotType.leftShoulder,
            EnumMechaSlotType.rightShoulder};
      case feetUpgrade:
