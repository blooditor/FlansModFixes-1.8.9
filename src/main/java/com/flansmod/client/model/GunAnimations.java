...
public class GunAnimations {
  ...
  public static GunAnimations defaults = new GunAnimations(null);
  ...
  public GunAnimations(EntityLivingBase entityLivingBase) {
    localPlayer = entityLivingBase == Minecraft.getMinecraft().thePlayer;
  }
